...
2. User Login & Authentication As a returning user, I want to be able to log in with my information securely so I can access my profile and feed. 
...
3. Post Creation As an active user, I want to be able to write text, post images, and directly link music on the platform to share my artistry. 
Assigned to: Leeyand Blot 
Tasks:
...
4. Community Feed As an active user, I want to be able to browse my feed of recent posts to discover new writings, art, and music. 
Assigned to: Sahara Calloway
Tasks:
